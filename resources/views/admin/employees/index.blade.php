...
@section('content')
    ...
    <div id="addEmployeeModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative mx-auto mt-32 mb-10 p-0 w-full max-w-2xl shadow-2xl rounded-2xl bg-white">
            ...
            <form id="addEmployeeForm" method="POST" action="{{ route('admin.employees.store') }}"
                class="space-y-4 px-8 pb-8 pt-2">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="position" id="position" required
                            placeholder="Jabatan (misal: Staff, Manager)"
                            class="w-full rounded-xl border-gray-300 shadow-sm bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500 p-3 text-base">
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="block text-gray-700 text-base font-semibold mb-1" for="date_joined">Tanggal
                            Bergabung</label>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <div>
                                <label class="block text-gray-700 text-xs mb-1" for="annual_leave_quota">Cuti
                                    Tahunan</label>
                                <input type="number" name="annual_leave_quota" id="annual_leave_quota" required
                                    min="0" value="12"
                            ...
                            <div>
                                ...
                                <input type="number" name="sick_leave_quota" id="sick_leave_quota" required
                                    min="0" value="12"
                                    class="w-full rounded-xl border-gray-300 shadow-sm bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500 p-2 text-base">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-xs mb-1"
                                    for="emergency_leave_quota">Darurat</label>
                                <input type="number" name="emergency_leave_quota" id="emergency_leave_quota" required
                                    min="0" value="6"
                                    class="w-full rounded-xl border-gray-300 shadow-sm bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500 p-2 text-base">
                            </div>
                        </div>
        ...
        <div class="relative mx-auto mt-32 mb-10 p-0 w-full max-w-3xl shadow-2xl rounded-2xl bg-white">
            ...
            <form id="editEmployeeForm" method="POST" class="space-y-4 px-8 pb-8 pt-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-gray-700 text-base font-semibold mb-1"
                            for="edit_position">Jabatan</label>
                        <input type="text" name="position" id="edit_position" required
                            class="w-full rounded-xl border-gray-300 shadow-sm bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500 p-3 text-base">
                    </div>
                    <div>
                        <label class="block text-gray-700 text-base font-semibold mb-1" for="edit_password">Password
                            (Kosongkan bila tidak ingin dirubah)</label>
                        <input type="password" name="password" id="edit_password"
                            class="w-full rounded-xl border-gray-300 shadow-sm bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500 p-3 text-base">
                    </div>
                    <div>
                        <label class="block text-gray-700 text-base font-semibold mb-1" for="edit_date_joined">Tanggal
                            Bergabung</label>
                        <input type="date" name="date_joined" id="edit_date_joined" required
                            class="w-full rounded-xl border-gray-300 shadow-sm bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500 p-3 text-base">
                    </div>
                    <div>
                        <label class="block text-gray-700 text-base font-semibold mb-1" for="edit_gaji_pokok">Gaji
                            Pokok</label>
                        <div class="flex items-center">
                            <span class="inline-block mr-2 text-gray-500 font-semibold">Rp</span>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <div>
                                <label class="block text-gray-700 text-xs mb-1" for="edit_annual_leave_quota">Cuti
                                    Tahunan</label>
                                <input type="number" name="annual_leave_quota" id="edit_annual_leave_quota" required
                                    min="0"
                                    class="w-full rounded-xl border-gray-300 shadow-sm bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500 p-2 text-base">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-xs mb-1" for="edit_sick_leave_quota">Sakit</label>
                                <input type="number" name="sick_leave_quota" id="edit_sick_leave_quota" required
                                    min="0"
                                    class="w-full rounded-xl border-gray-300 shadow-sm bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500 p-2 text-base">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-xs mb-1"
                                    for="edit_emergency_leave_quota">Darurat</label>
                                <input type="number" name="emergency_leave_quota" id="edit_emergency_leave_quota"
                                    required min="0"
                                    class="w-full rounded-xl border-gray-300 shadow-sm bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500 p-2 text-base">
                            </div>
                        </div>
        ...
        function showFormErrors(form, errors) {
            ...
            Object.keys(errors).forEach(function(key) {
                errors[key].forEach(function(msg) {
                    html +=
                        '<div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg relative mb-2">• ' +
                        msg + '</div>';
                });
            });
